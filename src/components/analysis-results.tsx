...
interface AnalysisResultsProps {
  ...
  isLoading: boolean; // For Lexical Analysis
            ...
            <TabsContent value="intermediateCode" className="mt-0 space-y-4">
                {isLoading || isIntermediateCodeLoading ? renderSkeletonList(15, false) : (
                    hasIntermediateCodeContent ? (
                        <>
                             <ResultListDisplay title="Three-Address Code (Lexer)" items={tac} isLoading={isLoading} loadingMessage="" emptyMessage="No TAC generated by lexer." gradientFrom="from-muted/50" gradientTo="to-secondary/30" borderColor="border-accent/50" hideTitle={isLoading}/>
